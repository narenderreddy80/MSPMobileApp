...
class _ConversationsScreenState extends State<ConversationsScreen> {
  ...
  Future<void> _fetch() async {
    ...
    try {
      final data = await _service.getMyConversations();
          ...
          : _error != null
              ...
              : _convs.isEmpty
                  ? const Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      SizedBox(height: 6),
                      Text('Contact a farmer from a listing to start chatting',
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Text(c.listingCropName.isNotEmpty
                                  ? c.listingCropName[0].toUpperCase() : 'C',
                                style: const TextStyle(color: AppTheme.primary,
                                  fontWeight: FontWeight.bold)),
                            ),
                            title: Text(c.listingCropName,
                            ...
                            onTap: () {
                              ...
                              Navigator.push(context, MaterialPageRoute(
                                builder: (_) => ChatScreen(
                                  conversationId: c.id,
                                  otherPartyName: c.sellerName,
                                  cropName: c.listingCropName,
                                ),
                              )).then((_) => _fetch());
                            },
                          );
